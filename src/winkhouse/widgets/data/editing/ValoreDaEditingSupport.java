...
public class ValoreDaEditingSupport extends EditingSupport {
	...
	public ValoreDaEditingSupport(ColumnViewer viewer, 
	...
	protected boolean canEdit(Object arg0) {
		if (daACanEditCellHandlerFactory.getDaHandler() != null){
			...
			return daACanEditCellHandlerFactory.getDaHandler()
